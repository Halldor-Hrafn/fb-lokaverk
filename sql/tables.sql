...
CREATE TABLE IF NOT EXISTS public.notes (
    ...
    CONSTRAINT notes_user_email_fkey FOREIGN KEY (user_email) REFERENCES auth.users (email) ON DELETE SET NULL
) TABLESPACE pg_default;
...
CREATE TABLE public.questions (
    ...
    CONSTRAINT questions_user_email_fkey FOREIGN KEY (user_email) REFERENCES auth.users (email) ON DELETE SET NULL,
